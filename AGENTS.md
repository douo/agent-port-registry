...
- A master may proxy start/stop or clear logs only for an already registered slave
  service and only when the user explicitly triggers that runtime action.
